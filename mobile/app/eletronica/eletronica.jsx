...
const Sertanejo = ({ navigation }) => {
  const songs = [
    { id: 1, title: 'Cidade Vizinha', artist: 'Henrique & Juliano', image: require('../../assets/images/7.jpeg') },
    { id: 2, title: 'Barulho Do Foguete', artist: 'Zé Neto & Cristiano', image: require('../../assets/images/8.jpeg') },
    { id: 3, title: 'Declaração Pro Bar', artist: 'Guilherme & Benuto', image: require('../../assets/images/9.jpeg') },
  ];

  return (
    <View style={styles.container}>
      <Image source={require('../../assets/images/6.jpeg')} style={styles.bannerImage} />
